...
class parsingNet(torch.nn.Module):
    ...
    def __init__(
        ...
        # ── 대각선 앵커 수치 (변수명 유지) ─────────────────
        self.num_grid_row = num_grid_row      #  #cfg.num_cell_row
        self.num_cls_row  = num_cls_row        #cfg.num_row
        self.num_grid_col = num_grid_col      #  #cfg.num_cell_col
        self.num_cls_col  = num_cls_col         #cfg.num_col
    ...
    def forward(self, x):
        ...
        # MLP → 20 anchor 벡터
        out = self.cls(fea).reshape(-1, 20, 2048) #shape [4, 20, 2048]
